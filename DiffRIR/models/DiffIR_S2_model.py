...
class DiffRIRS2Model(SRModel):
    ...
    def __init__(self, opt):
        super(DiffRIRS2Model, self).__init__(opt)
    ...
    def nondist_validation(self, dataloader, current_iter, tb_logger, save_img):
        ...
        self.is_train = False
        super(DiffRIRS2Model, self).nondist_validation(dataloader, current_iter, tb_logger, save_img)
        self.is_train = True
