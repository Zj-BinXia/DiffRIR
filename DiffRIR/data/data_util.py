...
def paired_maskpaths_from_folder(folders, keys, filename_tmpl):
    ...
    assert len(input_paths) == len(mask_paths), (f'{input_key} and {mask_key} datasets have different number of images: '
                                               f'{len(input_paths)}, {len(mask_paths)}.')
    paths = []
    for gt_path in gt_paths:
        ...
        assert input_name in mask_paths, f'{input_name} is not in {mask_key}_paths.'
